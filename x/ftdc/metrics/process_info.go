...
// interfaces for all processes currently running on
// a system.
...
// Processinfo instance for the specified process.
func MakeProcessInfo(pid int32, message string) *ProcessInfo {
	p := &ProcessInfo{}

...
//
// Since this is a map, order of the fields when serialized is not
// defined and applications cannot manipulate the Raw value of this
// composer.
//
// The basic idea is taken from https://github.com/YoSmudge/go-stats.
func CollectBasicGoStats() map[string]any {
	goStatsCache.Lock()
...
// CollectGoStatsTotals is a GoRuntimeInfo that contains data
// collected from the Go runtime about the state of memory use and
// garbage collection.
//
// The data reported for the runtime event metrics (e.g. mallocs,
...
// CollectGoStatsCurrent has the same semantics as CollectGoStatsTotals,
// but additionally allows you to set a message string to annotate the
// data.
func CollectGoStatsCurrent(msg string) *GoRuntimeInfo {
...
// CollectGoStatsDeltas is a
// GoRuntimeInfo that contains data collected from the Go

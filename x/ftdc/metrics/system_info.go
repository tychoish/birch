...
// SystemInfo is a type that collects system-wide resource utilization
// statistics about memory, CPU, and network use.
...
// specified message.
func MakeSystemInfo(message string) *SystemInfo {
	var err error
	s := &SystemInfo{}
